...
Rails.application.config.assets.precompile += %w( nota.css )
...
Rails.application.config.assets.precompile += %w( maestros/pais.js )
Rails.application.config.assets.precompile += %w( maestros/dispositivos.js )
Rails.application.config.assets.precompile += %w( maestros/frecuencia_pagos.js )
...
Rails.application.config.assets.precompile += %w( maestros/notas.js )

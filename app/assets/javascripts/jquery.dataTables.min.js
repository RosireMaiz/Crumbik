...
b}function nb(a){var b=a.oClasses,c=a.sTableId,e=a.oLanguage,d=a.oPreviousSearch,f=a.aanFeatures,h='<div class="input-field col s12"><input type="text" class=" '+b.sFilterInput+'"/> </div>',i='',i=i.match(/_INPUT_/)?i.replace("_INPUT_",h):i+h,b=g("<div/>",{id:!f.f?c+"_filter":null,"class":b.sFilter}).append(g("<label/>").append(i)),f=function(){var b=!this.value?"":this.value;b!=d.sSearch&&(fa(a,{sSearch:b,bRegex:d.bRegex,bSmart:d.bSmart,bCaseInsensitive:d.bCaseInsensitive}),a._iDisplayStart=0,L(a))},h=null!==a.searchDelay?a.searchDelay:
...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activar para ordena ascendente",sSortDescending:": activar para ordenar descendente"},oPaginate:{sFirst:"Primero",sLast:"Ultimo",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No data available in table",sInfo:"Fila _START_ hasta _END_ de _TOTAL_",sInfoEmpty:"0 filas",sInfoFiltered:"(Total _MAX_ filas)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Ver _MENU_ filas",sLoadingRecords:"Cargando...",sProcessing:"buscando...",sSearch:"Buscar:",sSearchPlaceholder:"¿Buscar?",sUrl:"",sZeroRecords:"No se ha encotrado la busqueda"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
